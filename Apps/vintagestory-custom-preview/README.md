...
Vintage Story 1.22.0-pre.3 preview release - dedicated server with web console access via ttyd.
...
- Dedicated server for Vintage Story 1.22.0-pre.3 preview release
...
This is the 1.22.0-pre.3 preview/test version. For stable versions, use VintageStory app instead.
